...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  createProject: (config: {name: string; [key: string]: any}) =>
    ipcRenderer.send('create-project', config),
  ...
  isStartableProject: (path: string) =>
    ipcRenderer.invoke('is-startable-project', path),
